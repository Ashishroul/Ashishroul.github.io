      ...
      >
        ...
        >
          ...
          <CardBody>
            ...
            >
              Hello, I am <span style={{ color: "#4A90E2" }}>Ashish Roul</span>,
              a web development enthusiast from Bhubneswar, Odisha. My passion
              lies in mastering the{" "}
              <span style={{ color: "#4A90E2" }}>MERN stack</span>. While I am
              new to the field, I have gained{" "}
              <span style={{ color: "#4A90E2" }}>hands-on experience</span> with
              React, Node.js, Express, and MongoDB during my studies. I am
              dedicated to crafting user-friendly interfaces and scalable
              backends and constantly expanding my skillset. If you have
